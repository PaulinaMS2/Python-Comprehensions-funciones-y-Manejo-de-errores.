#print(0/0) 
# print(result)
# print('hola') #No se ejecuta por el error de arriba

suma = lambda x,y: x+ y
assert suma(2,2) == 4    #Hacer verificaciones sencillas del funcionamiento de nuesto codigo
...
#COMENTARIO CON LOS ERRORES MAS COMUNES DE PYTHON 
'''
